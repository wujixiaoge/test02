...
setup(
    ...
    url="https://github.com/geekan/StrataAI",
    author="Alexander Wu",
    author_email="alexanderwu@deepwisdom.ai",
    license="MIT",
    keywords="StrataAI multi-agent multi-role programming gpt llm metaprogramming",
    ...
    entry_points={
        "console_scripts": [
            "StrataAI=StrataAI.software_company:app",
        ],
    },
